...
<style>
    .buttongreen {
        ...
        border: 1px solid #00403A !important;
        color: #fff !important;
        cursor: pointer;
    ...
    <div class="container">
        <div class="row form-control">
            <form method="POST" action="/bmi">
                ...
                <input type="text" id="weight" name="weight" required value="{{ isset($weight) ? $weight : '' }}">

                <label>ส่วนสูง(เซนติเมตร):</label>
                <input type="text" id="height" name="height" required value="{{ isset($height) ? $height : '' }}">
            ...
            <form method="POST" action="/bmi/save">
                ...
                @csrf
                <p>ค่าที่ได้ :</strong> <input disabled="disabled" id="bmi" name="bmi" size="25" type="text" value="{{ $bmi }}"></p>
                <p>คุณอยู่ในเกณฑ์ :</strong> <input disabled="disabled" id="status" name="status" size="25" type="text" value="{{ $status }}"></p>
                ...
                <button type="button" class="buttonblue" onclick="clearInput()">เคลียร์ข้อมูล
                </button>
            </form>
            @endif
